...
export default function ExperienceSection() {
  return (
    <section className="py-8 sm:py-16 bg-coffee-950/90 relative overflow-hidden border-t border-coffee-800/50">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-caramel-500/10 rounded-full blur-[100px] pointer-events-none" />
